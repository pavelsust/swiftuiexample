...
private var videoURLs: [URL] = [
    URL(string: "http://lifetvbd.xyz:8080/2x6Mfws7vc/3ENWPmuKmR/1686.m3u8")!,
...
struct ContentVideoPlay : View {
    ...
    func getTotalDurationString() -> String {
       ...
       // let s = Int(totalDuration.truncatingRemainder(dividingBy: 60))
        return String(format: "%d:%02d", arguments: [1, 1])
    }
}
